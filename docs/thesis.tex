...
Diagrama de Euler con las proporción de la varianza de cada serie explicada por cada solapamiento (p.e. la región común entre DMI y 90º cEOF2 es la varianza en común entre esas variables). Diagrama de Euler mostrando la proporción de la varianza de cada serie (DMI, ONI y la fase de 90º del cEOF2) explicada por las demás (p.e. la región común entre DMI y ONI es la varianza del DMI explcada por el ONI y viceversa).
...
\section{Parte temporal}\label{parte-temporal}}
...
\section{Relación con el SAM}\label{relaciuxf3n-con-el-sam}}
