...
Áreas con puntos marcan regiones donde el p-valor de la diferencia entre el signo positivo y el negativo es menor que 0.01 ajustado por FDR.}\label{fig:eof1-regr-gh}
\end{figure}
...
Áreas con puntos marcan regiones donde el p-valor de la diferencia entre el signo positivo y el negativo es menor que 0.01 ajustado por FDR.}\label{fig:o3-regr}
\end{figure}
...
Áreas con puntos marcan regiones donde el p-valor de la diferencia entre el signo positivo y el negativo es menor que 0.01 ajustado por FDR.}\label{fig:sst-psi-2}
\end{figure}
...
Áreas con puntos marcan regiones donde el p-valor de la diferencia entre el signo positivo y el negativo es menor que 0.01 ajustado por FDR.}\label{fig:pp-temp-2}
\end{figure}
...
Áreas con puntos marcan regiones donde el p-valor de la diferencia entre el signo positivo y el negativo es menor que 0.01 ajustado por FDR, donde para estaciones distintas a SON, marca el p-valor de la diferencia respecto a SON.}\label{fig:season-regression}
\end{figure}
...
\cmidrule{2-4}
\multirow[t]{-2}{*}{\centering\arraybackslash MAM} & (0.077) & \textbf{(0.004)} & (0.812)\\
\cmidrule{1-4}
 & -0.06 & -0.16 & 0.04\\
\cmidrule{2-4}
...
\cmidrule{2-4}
\multirow[t]{-2}{*}{\centering\arraybackslash SON} & \textbf{(0.001)} & \textbf{(<0.001)} & (0.812)\\
\bottomrule
\end{tabular}
\end{table}
...
Áreas con puntos marcan regiones donde el p-valor de la diferencia entre el signo positivo y el negativo es menor que 0.01 ajustado por FDR.}\label{fig:pp-regr-oceania}
\end{figure}
