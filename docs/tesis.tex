...
\renewcommand{\includegraphics}{%
  \write\listofgraphics{\theps@count}%
  \ORIincludegraphics
}
...
\caption{(ref:series-largas-cap)}\label{fig:series-largas}
\end{figure}
...
\caption{Media multimodelo de las series temporales estandarizadas de las fases de 0º y 90º del cEOF1 para el experimento historical (azul) y para la suma de los experimentos hist-GHG, hist-stratO3 e hist-aer, es decir, los que consideran cambios antropogénicos (rojo).}\label{fig:suma}
\end{figure}
