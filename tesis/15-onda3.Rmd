...
```{r envolvente-ejemplo, fig.height=6, fig.width=5}
...
```{r raphael-regr, fig.height=6, fig.width=5}
hgt %>% 
  .[raphael, on = "time"] %>% 
...
```{r pseudo-raphael, fig.height=5, fig.width=6}
qs3 <- hgt %>% 
  .[lat == -50] %>% 
...
```{r cor-puntos, fig.height=6, fig.width=7}
...
```{r raphael-top8, fig.height=8, fig.width=7}
...
```{r zw3-top8, fig.height=6, fig.width=7}
zw3 <- zw3 %>% 
  .[order(-amplitude)] %>% 
  .[, time_factor := forcats::fct_inorder(format(time))]
