...
(ref:arg-enso-density-cap) Estimación de densidad por núcleos de la fase del cEOF2 para primaveras con ONI menor a -0.5, entre -0.5 y 0.5, y mayor a 0.5 para los modelos del CMIP6 en el período 1979--2014 y para ERA5 en el período `r periodo`. 
...
(ref:regresion-hgt-damip-cap) Regresión de anomalías de altura geopotencial con la fase de 0º (columna 1) y de 90º (columna 2) del cEOF1 en 50 hPa para el período `r trend_base`--2014 para los experimentos de CMIP6 y DAMIP (m).
...
(ref:suma-cap) Media multimodelo de las series temporales estandarizadas de las fases de 0º y 90º del cEOF1 para el experimento histocial y para la suma de los experimentos hist-GHG, hist-stratO3 e hist-aer. 
