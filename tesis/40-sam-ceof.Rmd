...
De hecho, el 90º cEOF2 comparte hasta `r scales::percent(max_r2[cEOF == "cEOF2" & term == "asym" & season == "SON"]$estimate^2, 2)` varianza con el A-SAM y sólo `r scales::percent(max_r2[cEOF == "cEOF2" & term == "sym" & season == "SON"]$estimate^2, 2)` como máximo con el S-SAM (Figura \@ref(fig:sam-eof-vertical).
b2).
