...
\Abstract{
\hypertarget{dynamics-of-the-southern-hemisphere-zonally-asymmetric-circulation}{%
\subsection{Dynamics of the Southern Hemisphere zonally asymmetric circulation}\label{dynamics-of-the-southern-hemisphere-zonally-asymmetric-circulation}}
...
\Resumen{
\hypertarget{dinuxe1mica-de-la-circulaciuxf3n-zonalmente-asimuxe9trica-del-hemisferio-sur}{%
\subsection{Dinámica de la circulación zonalmente asimétrica del hemisferio sur}\label{dinuxe1mica-de-la-circulaciuxf3n-zonalmente-asimuxe9trica-del-hemisferio-sur}}
...
\hypertarget{exploraciuxf3n-de-la-onda-3}{%
\section{Exploración de la onda 3}\label{exploraciuxf3n-de-la-onda-3}}
...
\hypertarget{raphael}{%
\subsection{Raphael}\label{raphael}}

Uno de los pocos índices establecidos en la literatura para medir la onda zonal 3 del hemisferio sur fue propuesto por Raphael (2004).
Consiste en el promedio de las anomalías zonales estandarizadas del promedio corrido de tres meses de altura geopotencial en 500 hPa en tres puntos, elegidos para coincidir aproximadamente con los máximos climatológicos de la onda 3 según van Loon and Jenne (1972).
...
\begin{figure}
\includegraphics{figures/15-onda3/raphael-regr-1} \caption{(ref:raphael-regr-cap)}\label{fig:raphael-regr}
\end{figure}

La Figura \ref{fig:raphael-regr} muestra los puntos definidos por Raphael (2004) y el mapa de regresión entre el índice propuesto y la anomalía zonal de altura geopotencial en 500 hPa.
...
La onda 3 descripta por el índice de Raphael (2004) coincide bien con la onda 3 climatológica (contornos negtros en la Fig \ref{fig:raphael-regr}).
Esto es por construcción, ya que al usar puntos fijos, el índice de (\textbf{raphael?}) busca medir la similitud del campo de anomalías zonales de altura geopotencial con la onda 3 climatológica.

\begin{figure}
\includegraphics{figures/15-onda3/pseudo-raphael-1} \caption{(ref:pseudo-raphael-cap)}\label{fig:pseudo-raphael}
\end{figure}

La Figura \ref{fig:pseudo-raphael} muestra la relación entre la anomalía zonal de altura geopotencial promediada en los tres puntos (índice de Raphael (2004) agrega promedio de 3 meses y estandarización) y la amplitud de la proyección del campo de anomalías de geopotencial en la dirección de la onda 3 climatológica.\\
...
La Tabla \ref{tab:raphael-correlation} muestra la matriz de correlación entre la anomalía zonal de altura geopotencial en los puntos en el índice de Raphael (2004), indicados por su longitud.
...
\begin{figure}
\includegraphics{figures/15-onda3/cor-puntos-1} \caption{(ref:cor-puntos-cap)}\label{fig:cor-puntos}
\end{figure}
...
\begin{figure}
\includegraphics{figures/15-onda3/raphael-top8-1} \caption{(ref:raphael-top8-cap)}\label{fig:raphael-top8-1}
\end{figure}
\begin{figure}
\includegraphics{figures/15-onda3/raphael-top8-2} \caption{(ref:raphael-top8-cap)}\label{fig:raphael-top8-2}
\end{figure}
...
Esta medida no mide exactamente lo mismo que el índice de Raphael (2004), ya que es sensible a la amplitud de la onda 3 sin importar dónde este localizada.
...
\begin{figure}
\includegraphics{figures/15-onda3/fase-histogram-1} \caption{(ref:fase-histogram-cap)}\label{fig:fase-histogram}
\end{figure}
...
\begin{figure}
\includegraphics{figures/15-onda3/zw3-top8-1} \caption{(ref:zw3-top8-cap)}\label{fig:zw3-top8}
\end{figure}
...
\begin{figure}
\includegraphics{figures/15-onda3/envelope-regr-1} \caption{(ref:envelope-regr-cap)}\label{fig:envelope-regr}
\end{figure}

La Figura \ref{fig:envelope-regr} muestra la regresión entre la amplitud de las ondas 1 a 4 y la envolvente de todas las ondas zonales (una medida de la actividad local de las ondas; ver (\textbf{virving2015?})) de las anomalías de altura geopotencial.
...
\todo[inline]{Esto se repite en el capítulo anterior. Habría que unificar metodología.}
...
\todo[inline]{Acá hay algunos cambios al extender los índices hasta 2022. Hay que cambiar un poco el texto.}
...
\todo[inline]{Esta sección hay que cambiarla, creo. La evidencia ya era poca en el paper y agregando datos hasta 2022 se hace aún más complejo. Creo que hay que verlo con más cuidado. Especialmente al mirar las series temporales de r2 (Siguiente figura).}
...
\todo[inline]{¿Qué quisimo decir con esto?}
