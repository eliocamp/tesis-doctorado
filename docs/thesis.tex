...
\cmidrule{1-4}
PSA1 &  & -0.17 (CI: -0.45 -- 0.14) & 0.36 (CI: 0.06 -- 0.6)\\
\cmidrule{1-1}
\cmidrule{3-4}
...
\cmidrule{1-4}
PSA1 &  & 0.16 (CI: -0.16 -- 0.44) & \textbf{0.74 (CI: 0.56 -- 0.85)}\\
\cmidrule{1-1}
\cmidrule{3-4}
PSA2 & \multirow[t]{-2}{*}{\raggedright\arraybackslash SON} & \textbf{0.75 (CI: 0.58 -- 0.86)} & 0.3 (CI: -0.01 -- 0.55)\\
\bottomrule
\end{tabular}
\end{table}
...
\todo[inline]{Faltaría analizar las otras estaciones, pero quiero ver lo anterior primero}
