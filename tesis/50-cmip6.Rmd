...
Encontraron que la tendencia positiva del SAM es simulada correctamente por los modelos de CMIP5 y CMIP6 y que puede atribuirse tanto al efecto de los gases de efecto invernadero como a la destrucción del ozono estratosférico [@gillett2013; @ipcc5ch3]. 
...
Este efecto combinado de ambos forzantes ha sido ya identificada por trabajos previos como aquella que mayormente explica la intensificación y progresión hacia el polo de los vientos del oeste [@ipcc5ch3]. 
