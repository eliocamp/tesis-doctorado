...
# Exploración de las formas de descripción de la onda 3
...
Utilizamos datos del período post-satelital (`r periodo`) para garantizar la mayor cobertura posible de datos en el hemisferio sur que hayan alimentado al sistema de reanálisis.
...
```{r pseudo-raphael, fig.height=3, fig.width=4}
qs3 <- hgt %>% 
  .[lat == -50] %>% 
...
cor_puntos %>% 
  ...
  setnames("item1", "") %>% 
  kbl(align = "c", 
      caption = "Correlación entre la anomalía zonal de geopotential en los tres puntos utilizados para construir R04.", 
