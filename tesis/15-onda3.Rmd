...
Utilizamos datos del período post-satelital (`r periodo`) para minimizar posibles problemas causados por cambios en la cobertura de datos.
...
```{r fase-histogram, fig.height=3, fig.width=6}
zw %>%
  .[k == 3] %>% 
  .[type == "zonal"] %>% 
