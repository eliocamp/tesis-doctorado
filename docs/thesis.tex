...
{\centering \includegraphics{figures/50-cmip6/series-largas-mod-1} 

}

\caption{Igual que \ref{fig:series-largas} pero para la magnitud de los cEOFs.}\label{fig:series-largas-mod}
\end{figure}
...
{\centering \includegraphics{figures/50-cmip6/ceof-damip-mod-1} 

}

\caption{(ref:ceof-damip-mod-cap)}\label{fig:ceof-damip-mod}
\end{figure}
